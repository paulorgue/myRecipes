...
export class RegisterComponent {
  ...
  passwordValidator(minlength: number): ValidatorFn {
    ...
    sendRegistration(){
      this.supaService.registration(this.registerForm.get('email')?.value, this.registerForm.get('passwords.password')?.value).subscribe(
        {next: registrationdata => console.log(registrationdata),
